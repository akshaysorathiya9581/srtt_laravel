...
<!-- end row -->
   ...
   <div class="row">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="card-box">
                <form action="{{ route('paxprofile.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="f_name">FIRST NAME<span class="text-danger">*</span></label>
                                <input type="text" name="f_name" placeholder="Enter First Name" class="form-control " value="{{ old('f_name') }}" autocomplete="off">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="m_name" placeholder="Enter Middle Name" class="form-control " value="{{ old('m_name') }}" autocomplete="off">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="l_name" placeholder="Enter Last Name" class="form-control " value="{{ old('l_name') }}" autocomplete="off">
